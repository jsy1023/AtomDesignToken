...
import { 
  ...
  CollapseHeader, 
  CollapseContent 
} from "../templates/Collapse/Collapse";

const DocsLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <main className="flex flex-1 w-full min-h-0 overflow-hidden">
        <Sidebar minWidth={240}>
          <CollapseProvider type="accordion" defaultActiveKeys={["component"]}>
            <Collapse className="border-none">
              
              <CollapseItem value="start" className="border-none">
                <CollapseHeader className="text-sm font-semibold opacity-70 uppercase tracking-wider">
                  시작하기
                </CollapseHeader>
                <CollapseContent>
                  <SideNavList>
              ...
              <CollapseItem value="token" className="border-none">
                <CollapseHeader className="text-sm font-semibold opacity-70 uppercase tracking-wider">
                  디자인 토큰
                </CollapseHeader>
                <CollapseContent>
              ...
              <CollapseItem value="component" className="border-none">
                <CollapseHeader className="text-sm font-semibold opacity-70 uppercase tracking-wider">
                  component
                </CollapseHeader>
                <CollapseContent>
