  ...
  return (
    <html lang="ko" className="w-full h-full">
      ...
      <body className="w-full h-full bg-bg-wrapper">
        <Navigation
          type="topnav"
          className="fixed flex items-center justify-between w-full h-[64px] px-6 z-50 border-b border-border-topnav bg-bg-topnav/80 backdrop-blur-md"
        >
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              target="_blank"
              className="flex items-center gap-2 text-sm font-medium hover:text-primary transition-colors bg-bg-topnav/50 py-1.5 px-3 rounded-full border border-border-topnav"
            >
              <svg
                viewBox="0 0 24 24"
                width="18"
                height="18"
                fill="currentColor"
                className="text-text-topnav-standard"
              >
