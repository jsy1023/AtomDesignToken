...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* Hero Section */}
      <section className="relative overflow-hidden py-24 px-6 bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500">디자인 시스템을 만드는 가장 꼼꼼하고 효율적인 방법들을 담았습니다.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {advantages.map((adv, index) => (
              <Card key={index} className="p-8 hover:translate-y-[-4px] transition-transform duration-300 border-none shadow-sm bg-gray-50/50">
      ...
      <section className="py-24 px-6 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-black/20 p-4 rounded-lg font-mono text-sm mb-10 inline-block border border-white/20">
            npx atomsystem-init
          </div>
          <div>
