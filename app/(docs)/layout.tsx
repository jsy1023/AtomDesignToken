  ...
  return (
    <>
      <main className="flex flex-col w-full h-full">
        <Navigation type="topnav" className="fixed flex items-center justify-between w-full py-2 px-4 z-50 border-b h-[64px] overflow-hidden">
          <div className="flex">
            <Link href={"/"}>
              <Image
            ...
            >
              <span
                className="material-symbols-outlined text-[var(--text-topnav-standard)]"
                style={{ fontSize: "16px" }}
              >
                menu
              </span>
        ...
        <div className="flex w-full h-full min-h-0 pt-[64px]">
          ...
          >
            <div className="flex flex-col h-full w-full overflow-auto">
              <p className="px-4 py-2 text-[var(--text-sidenav-standard)] font-bold">시작하기</p>
              <div className="px-4">
                <NavItems
                  navMenu={[
                    { name: "소개", path: "/" },
              ...
              <p className="px-4 py-2 text-[var(--text-sidenav-standard)] font-bold">디자인 토큰</p>
              <div className="px-4">
                <NavItems
                  navMenu={[
              ...
              <p className="px-4 py-2 text-[var(--text-sidenav-standard)] font-bold">component</p>
              <div className="px-4">
                <NavItems
                  navMenu={[
