...
import StyleDictionaryLogoImage from "@/public/images/gettingStarted/styledictionary_logo.webp";
...
const DocsHome = () => {
  ...
  return (
    <div>
      ...
      <p className="text-textSub">base Atomic Design System</p>
      ...
      <hr className="my-4" />
      <h6 className="mb-4">아래의 기술을 사용합니다.</h6>
      <div className="flex  flex-wrap w-full">
        <div className="w-1/3 px-2 mb-4">
          <Link href={"https://react.dev/learn"} target="_blank">
            <Card className="p-8 flex flex-col items-center gap-4 h-full justify-center">
              <svg
                width="100%"
                height="100%"
                ...
                className="w-16 h-16 text-[#58c4dc]"
              >
        ...
        <div className="w-1/3 px-2 mb-4">
          <Link
            href={"https://styledictionary.com/getting-started/installation/"}
            target="_blank"
          >
            <Card className="p-8 flex flex-col items-center gap-4 h-full justify-center">
              <Image
                src={StyleDictionaryLogoImage}
                alt="styledictionary"
                className="w-16 h-16"
              />
              <h6 className="flex gap-1">
        ...
        <div className="w-1/3 px-2 mb-4">
          <Card className="p-4 text-center">Figma</Card>
        </div>
        <div className="w-1/3 px-2 mb-4">
          <Card className="p-4 text-center">Token Studio</Card>
        </div>
      </div>
      <hr className="my-4" />
