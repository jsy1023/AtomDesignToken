...
npm 명령어를 통해 atomsystem을 다운로드 할 수 있습니다.

<CodeLayout code={`npx i atomsystem`} />

---

atomsystem은 react, next.js, tailwinds css를 의존하는 library
입니다. 설치 뒤 다운로드해도 되며 npx 명령어를 통해 라이브러리를
생성할 수 있습니다.
...
<CodeLayout language="npm" code={`npx atomsystem-add`} />
